...
public class JuHeUtils {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="d33ef3d387845f318b509e39655d5e95";
    ...
    //2.发送短信
    public static void sendValidateCode(String phone , String message){
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile",phone);//接收短信的手机号码
        params.put("tpl_id","170957");//短信模板ID，请参考个人中心短信模板设置
    ...
    //2.预约成功使用
    public static void orderSuccess(String phone){
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile",phone);//接收短信的手机号码
        params.put("tpl_id","170958");//短信模板ID，请参考个人中心短信模板设置
    ...
    //2.登录使用
    public static void sendLogin(String phone , String message){
        String result =null;
        String url ="http://v.juhe.cn/sms/send";//请求接口地址
        Map params = new HashMap();//请求参数
        params.put("mobile",phone);//接收短信的手机号码
        params.put("tpl_id","170959");//短信模板ID，请参考个人中心短信模板设置
        params.put("tpl_value","#code#="+message);//变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a href="http://www.juhe.cn/news/index/id/50" target="_blank">详细说明></a>
        params.put("key",APPKEY);//应用APPKEY(应用详细页查询)
        params.put("dtype","");//返回数据的格式,xml或json，默认json
...
//        getRequest2("15246140338" , "#code#=666666");
//        getRequest3("15246140338");
    }
    /**
     *
     * @param strUrl 请求地址
